...
console.log("This is Suriya priyan");
...
var user1 = [
    { id: 1, name:'kondareddy',orderdetails: 'cakes',  order: 1, deliverd: true},

    { id: 2, name:'romeo', orderdetails: 'juice',     order: 2, deliverd: true},

    { id: 3, name:'jakky',orderdetails: 'shwarama', order: 3, deliverd: true},

    { id: 4, name:'jones',orderdetails: 'poni pori',     order: 4, deliverd: false},

    { id: 5, name:'kings',orderdetails: 'fish finger',   order: 5, deliverd: false},
];
